...
tld_labels = [
    ...
    'aco', 'actor', 'ad', 'adac', 'ads', 'adult', 'ae', 'aeg', 'aero', 'aetna',
    ...
    'care', 'career', 'careers', 'cars', 'casa', 'case', 'cash', 'casino',
    'cat', 'catering', 'catholic', 'cba', 'cbn', 'cbre', 'cbs', 'cc', 'cd',
    ...
    'codes', 'coffee', 'college', 'cologne', 'com', 'comcast', 'commbank',
    ...
    'day', 'dclk', 'dds', 'de', 'deal', 'dealer', 'deals', 'degree', 'delivery',
    ...
    'hot', 'hoteles', 'hotels', 'hotmail', 'house', 'how', 'hr', 'hsbc', 'ht',
    ...
    'it', 'itau', 'itv', 'jaguar', 'java', 'jcb', 'je', 'jeep', 'jetzt', 'jewelry',
    ...
    'museum', 'mutual', 'mv', 'mw', 'mx', 'my', 'mz', 'na', 'nab', 'nagoya',
    'name', 'natura', 'navy', 'nba', 'nc', 'ne', 'nec', 'net', 'netbank', 'netflix',
    ...
    'pizza', 'pk', 'pl', 'place', 'play', 'playstation', 'plumbing', 'plus',
    ...
    'schmidt', 'scholarships', 'school', 'schule', 'schwarz', 'science', 'scjohnson',
    'scot', 'sd', 'se', 'search', 'seat', 'secure', 'security', 'seek', 'select',
    'sener', 'services', 'ses', 'seven', 'sew', 'sex', 'sexy', 'sfr', 'sg',
    'sh', 'shangrila', 'sharp', 'shaw', 'shell', 'shia', 'shiksha', 'shoes',
    ...
    'tienda', 'tiffany', 'tips', 'tires', 'tirol', 'tj', 'tjmaxx', 'tjx', 'tk',
    ...
    'wme', 'wolterskluwer', 'woodside', 'work', 'works', 'world', 'wow', 'ws',
    'wtc', 'wtf', 'xbox', 'xerox', 'xfinity', 'xihuan', 'xin', 'xn--11b4c3d',
